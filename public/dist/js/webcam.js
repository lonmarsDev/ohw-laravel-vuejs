...
window.webcam = {
	...
	swf_url: 'resource/dist/images/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'resource/dist/images/shutter.mp3', // URI to shutter.mp3 sound
	...
	get_html: function(width, height, server_width, server_height) {
		...
		if (this.ie) {
			...
			html += '<embed id="webcam_movie" src="'+this.swf_url+'" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="100%" height="'+height+'" name="webcam_movie" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="'+flashvars+'" />'; //width="'+width+'"
		}
