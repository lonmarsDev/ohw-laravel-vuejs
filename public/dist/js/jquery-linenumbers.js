(function($){
    $.fn.linenumbers = function(in_opts){
        ...
        return this.each(function(){
            ...
            $(this).before('<textarea data-name="linenumbers" style="width:50px;height:'+textarea_height+'px;float:left;white-space:pre;overflow:hidden;background:#eee;color:#000;padding-left:10px;border-top-right-radius:0px;border-bottom-right-radius:0px;position:absolute;text-align:center;" disabled="disabled"></textarea>');
            // Edit the existing textarea's styles
            $(this).css({'width':'100%','height':textarea_height+'px'});
            // Add a clearing div.
...
(function($){
    $.fn.linenumbers1 = function(in_opts){
        // Settings and Defaults
        var opt = $.extend({
            col_width: '65px',
            start: 1,
        ...
        return this.each(function(){
            ...
            var new_textarea_width = parseInt(textarea_width)-parseInt(opt.col_width);
            // Create the new textarea and style it
            $(this).before('<textarea data-name="linenumbers1" style="width:50px;height:'+textarea_height+'px;float:left;white-space:pre;overflow:hidden;background:#eee;color:#000;padding-left:10px;border-top-right-radius:0px;border-bottom-right-radius:0px;position:absolute;text-align:center;" disabled="disabled"></textarea>');
            // Edit the existing textarea's styles
            $(this).css({'width':'100%','height':textarea_height+'px'});
            // Add a clearing div.
            $(this).after('<div style="clear:both;"></div>');
