...
import listRoutes from './../components/permissions/routelist';
import attachToRole from './../components/permissions/attachToRole';
// import Toastr
...
Vue.component('list-routes',listRoutes);
Vue.component('attach-roles',attachToRole);
  ...
  methods:{
    ...
    */
    save(){
        ...
        this.$http.post('/admin/permissions',this.model).then(function(response, status, header){
    ...
    */
    fetchList(){
      this.submitting = true;
      this.loading2 = true;
      this.$http.get('/admin/permissions/list').then(function(response, status, header){
          let me = this;
    ...
    redirect(id){
      window.location.href ='/admin/permissions/'+id+'/attached/role/';
    },
    /**
    ...
    */
    fetchById(id){
      this.submitting = true,
       this.loading2 = true;
      this.$http.get('/admin/permissions/'+id).then(function(response, status, header){
    ...
    */
    update(){
      ...
      this.$http.put('/admin/permissions/'+this.model_update.id,this.model_update).then(function(response, status, header){
         this.$toastr.s(response.body.message,'Success');   
          this.submitting= false;
    ...
    Clickdelete(id){
     ...
     var  me =this;
      ...
      .then(function () {
          ...
          me.$http.delete('/admin/permissions/'+id).then(function(response, status, header){
